...
* Are distributed table-like collections with well-defined rows and columns, represent inmutable, lazily evaluated plans that specify what operations to apply to data residing at a location to generate some input
...
* Within the Structured APIs, there are the "untyped" DataFrames and the "typed" Datasets
