...
* Each time a command is typed and the ENTER key is pressed, bash performs several substitutions upon the text before it carries out the command. This process is called *expansion*
...
* Arithmetic expansion: Allows arithmetics to be performed by expansion `echo $((expression))`
